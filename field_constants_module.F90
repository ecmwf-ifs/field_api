...
INTEGER (KIND=JPIM), PARAMETER :: UNINITIALIZED_GPU =  INT(B'00001000', KIND=JPIM)
INTEGER (KIND=JPIM), PARAMETER :: UNINITIALIZED_CPU =  INT(B'00010000', KIND=JPIM)
INTEGER (KIND=JPIM), PARAMETER :: UNINITIALIZED     =  INT(B'00011000', KIND=JPIM)
