...
CONTAINS
  ...
  PROCEDURE :: PRINT_STATUS => FIELD_BASIC_PRINT_STATUS
...
FUNCTION FIELD_BASIC_PRINT_STATUS (SELF)

CLASS (FIELD_BASIC) :: SELF
INTEGER:: FIELD_BASIC_PRINT_STATUS
FIELD_BASIC_PRINT_STATUS=SELF%ISTATUS

END FUNCTION

SUBROUTINE FIELD_BASIC_ADD_STATUS(SELF, STATUS)

CLASS (FIELD_BASIC) :: SELF
INTEGER, INTENT(IN) :: STATUS
SELF%ISTATUS=IOR(SELF%ISTATUS, STATUS)

END SUBROUTINE FIELD_BASIC_ADD_STATUS

SUBROUTINE FIELD_BASIC_REMOVE_STATUS(SELF, STATUS)

CLASS (FIELD_BASIC) :: SELF
INTEGER, INTENT(IN) :: STATUS
SELF%ISTATUS=IAND(SELF%ISTATUS, .NOT. STATUS)

END SUBROUTINE FIELD_BASIC_REMOVE_STATUS

LOGICAL FUNCTION FIELD_BASIC_IS_STATUS (SELF, STATUS)

CLASS (FIELD_BASIC) :: SELF
INTEGER, INTENT(IN) :: STATUS

FIELD_BASIC_IS_STATUS = (IAND(SELF%GET_STATUS(), STATUS) == STATUS)
