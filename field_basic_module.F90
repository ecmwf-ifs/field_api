...
CONTAINS
  ...
  PROCEDURE (FIELD_BASIC_DELETE), DEFERRED :: DELETE_DEVICE_DATA
  PROCEDURE (FIELD_BASIC_CREATE), DEFERRED :: CREATE_DEVICE_DATA
...
ABSTRACT INTERFACE
  ...
  END SUBROUTINE
  SUBROUTINE FIELD_BASIC_DELETE (SELF)
    IMPORT FIELD_BASIC
    CLASS(FIELD_BASIC), INTENT(INOUT) :: SELF
  END SUBROUTINE
  SUBROUTINE FIELD_BASIC_CREATE (SELF)
    IMPORT FIELD_BASIC
    CLASS(FIELD_BASIC), INTENT(INOUT), TARGET :: SELF
  END SUBROUTINE
END INTERFACE
...
CALL ABOR1 ('FIELD_BASIC_SET_CHILDREN_DEVPTR: SHOULD NOT BE CALLED')
