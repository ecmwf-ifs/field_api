...
Z3 => MOVE_DATA_FROM_DEVICE_RDONLY (YLF3)
WRITE (*, '(B32.32)') YLF3%ISTATUS
...
PRINT *, '----------- DEVICE ----------- R '
WRITE (*, '(B32.32)') YLF3%ISTATUS
Z3 => MOVE_DATA_TO_DEVICE_RDONLY (YLF3)
WRITE (*, '(B32.32)') YLF3%ISTATUS
...
PRINT *, '----------- DEVICE ----------- W '
WRITE (*, '(B32.32)') YLF3%ISTATUS
Z3 => MOVE_DATA_TO_DEVICE_RDWR (YLF3)
WRITE (*, '(B32.32)') YLF3%ISTATUS
...
Z4 => MOVE_DATA_FROM_DEVICE_RDWR (YLF4)
...
Z4 => MOVE_DATA_TO_DEVICE_RDWR (YLF4)
...
Z4 => MOVE_DATA_FROM_DEVICE_RDONLY (YLF4)
