...
CALL MOVE_DATA_FROM_DEVICE_RDONLY (YLF3, Z3)
WRITE (*, '(B32.32)') YLF3%ISTATUS
...
PRINT *, '----------- DEVICE ----------- R '
WRITE (*, '(B32.32)') YLF3%ISTATUS
CALL MOVE_DATA_TO_DEVICE_RDONLY (YLF3, Z3)
WRITE (*, '(B32.32)') YLF3%ISTATUS
...
PRINT *, '----------- DEVICE ----------- W '
WRITE (*, '(B32.32)') YLF3%ISTATUS
CALL MOVE_DATA_TO_DEVICE_RDWR (YLF3, Z3)
WRITE (*, '(B32.32)') YLF3%ISTATUS
...
CALL MOVE_DATA_FROM_DEVICE_RDWR (YLF4, Z4)
...
CALL MOVE_DATA_TO_DEVICE_RDWR (YLF4, Z4)
...
CALL MOVE_DATA_FROM_DEVICE_RDONLY (YLF4, Z4)
