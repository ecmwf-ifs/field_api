...
!$ACC END KERNELS
        ...
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1RD, DATA_CPU_1RD, filenames,"DATA_CPU_1RD")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1IM, DATA_CPU_1IM, filenames,"DATA_CPU_1IM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1LM, DATA_CPU_1LM, filenames,"DATA_CPU_1LM")

        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2RB, DATA_CPU_2RB, filenames,"DATA_CPU_2RB")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2RM, DATA_CPU_2RM, filenames,"DATA_CPU_2RM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2RD, DATA_CPU_2RD, filenames,"DATA_CPU_2RD")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2IM, DATA_CPU_2IM, filenames,"DATA_CPU_2IM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2LM, DATA_CPU_2LM, filenames,"DATA_CPU_2LM")

        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3RB, DATA_CPU_3RB, filenames,"DATA_CPU_3RB")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3RM, DATA_CPU_3RM, filenames,"DATA_CPU_3RM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3RD, DATA_CPU_3RD, filenames,"DATA_CPU_3RD")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3IM, DATA_CPU_3IM, filenames,"DATA_CPU_3IM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3LM, DATA_CPU_3LM, filenames,"DATA_CPU_3LM")

        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4RB, DATA_CPU_4RB, filenames,"DATA_CPU_4RB")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4RM, DATA_CPU_4RM, filenames,"DATA_CPU_4RM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4RD, DATA_CPU_4RD, filenames,"DATA_CPU_4RD")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4IM, DATA_CPU_4IM, filenames,"DATA_CPU_4IM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4LM, DATA_CPU_4LM, filenames,"DATA_CPU_4LM")

        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5RB, DATA_CPU_5RB, filenames,"DATA_CPU_5RB")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5RM, DATA_CPU_5RM, filenames,"DATA_CPU_5RM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5RD, DATA_CPU_5RD, filenames,"DATA_CPU_5RD")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5IM, DATA_CPU_5IM, filenames,"DATA_CPU_5IM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5LM, DATA_CPU_5LM, filenames,"DATA_CPU_5LM")


        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1RB, DATA_GPU_1RB, filenames,"DATA_GPU_1RB", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1RM, DATA_GPU_1RM, filenames,"DATA_GPU_1RM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1RD, DATA_GPU_1RD, filenames,"DATA_GPU_1RD", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1IM, DATA_GPU_1IM, filenames,"DATA_GPU_1IM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1LM, DATA_GPU_1LM, filenames,"DATA_GPU_1LM", LSYNC=.TRUE.)

        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2RB, DATA_GPU_2RB, filenames,"DATA_GPU_2RB", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2RM, DATA_GPU_2RM, filenames,"DATA_GPU_2RM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2RD, DATA_GPU_2RD, filenames,"DATA_GPU_2RD", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2IM, DATA_GPU_2IM, filenames,"DATA_GPU_2IM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2LM, DATA_GPU_2LM, filenames,"DATA_GPU_2LM", LSYNC=.TRUE.)

        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3RB, DATA_GPU_3RB, filenames,"DATA_GPU_3RB", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3RM, DATA_GPU_3RM, filenames,"DATA_GPU_3RM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3RD, DATA_GPU_3RD, filenames,"DATA_GPU_3RD", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3IM, DATA_GPU_3IM, filenames,"DATA_GPU_3IM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3LM, DATA_GPU_3LM, filenames,"DATA_GPU_3LM", LSYNC=.TRUE.)

        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4RB, DATA_GPU_4RB, filenames,"DATA_GPU_4RB", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4RM, DATA_GPU_4RM, filenames,"DATA_GPU_4RM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4RD, DATA_GPU_4RD, filenames,"DATA_GPU_4RD", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4IM, DATA_GPU_4IM, filenames,"DATA_GPU_4IM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4LM, DATA_GPU_4LM, filenames,"DATA_GPU_4LM", LSYNC=.TRUE.)

        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5RB, DATA_GPU_5RB, filenames,"DATA_GPU_5RB", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5RM, DATA_GPU_5RM, filenames,"DATA_GPU_5RM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5RD, DATA_GPU_5RD, filenames,"DATA_GPU_5RD", LSYNC=.TRUE.)
