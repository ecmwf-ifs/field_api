...
!$ACC END KERNELS
        ...
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1RB, DATA_CPU_1RB, h5filename, "DATA_CPU_1RB")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1RM, DATA_CPU_1RM, h5filename, "DATA_CPU_1RM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1RD, DATA_CPU_1RD, h5filename, "DATA_CPU_1RD")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1IM, DATA_CPU_1IM, h5filename, "DATA_CPU_1IM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1LM, DATA_CPU_1LM, h5filename, "DATA_CPU_1LM")

        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2RB, DATA_CPU_2RB, h5filename, "DATA_CPU_2RB")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2RM, DATA_CPU_2RM, h5filename, "DATA_CPU_2RM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2RD, DATA_CPU_2RD, h5filename, "DATA_CPU_2RD")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2IM, DATA_CPU_2IM, h5filename, "DATA_CPU_2IM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2LM, DATA_CPU_2LM, h5filename, "DATA_CPU_2LM")

        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3RB, DATA_CPU_3RB, h5filename, "DATA_CPU_3RB")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3RM, DATA_CPU_3RM, h5filename, "DATA_CPU_3RM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3RD, DATA_CPU_3RD, h5filename, "DATA_CPU_3RD")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3IM, DATA_CPU_3IM, h5filename, "DATA_CPU_3IM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3LM, DATA_CPU_3LM, h5filename, "DATA_CPU_3LM")

        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4RB, DATA_CPU_4RB, h5filename, "DATA_CPU_4RB")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4RM, DATA_CPU_4RM, h5filename, "DATA_CPU_4RM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4RD, DATA_CPU_4RD, h5filename, "DATA_CPU_4RD")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4IM, DATA_CPU_4IM, h5filename, "DATA_CPU_4IM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4LM, DATA_CPU_4LM, h5filename, "DATA_CPU_4LM")

        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5RB, DATA_CPU_5RB, h5filename, "DATA_CPU_5RB")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5RM, DATA_CPU_5RM, h5filename, "DATA_CPU_5RM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5RD, DATA_CPU_5RD, h5filename, "DATA_CPU_5RD")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5IM, DATA_CPU_5IM, h5filename, "DATA_CPU_5IM")
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5LM, DATA_CPU_5LM, h5filename, "DATA_CPU_5LM")


        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1RB, DATA_GPU_1RB, h5filename, "DATA_GPU_1RB", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1RM, DATA_GPU_1RM, h5filename, "DATA_GPU_1RM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1RD, DATA_GPU_1RD, h5filename, "DATA_GPU_1RD", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1IM, DATA_GPU_1IM, h5filename, "DATA_GPU_1IM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_1LM, DATA_GPU_1LM, h5filename, "DATA_GPU_1LM", LSYNC=.TRUE.)

        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2RB, DATA_GPU_2RB, h5filename, "DATA_GPU_2RB", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2RM, DATA_GPU_2RM, h5filename, "DATA_GPU_2RM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2RD, DATA_GPU_2RD, h5filename, "DATA_GPU_2RD", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2IM, DATA_GPU_2IM, h5filename, "DATA_GPU_2IM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_2LM, DATA_GPU_2LM, h5filename, "DATA_GPU_2LM", LSYNC=.TRUE.)

        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3RB, DATA_GPU_3RB, h5filename, "DATA_GPU_3RB", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3RM, DATA_GPU_3RM, h5filename, "DATA_GPU_3RM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3RD, DATA_GPU_3RD, h5filename, "DATA_GPU_3RD", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3IM, DATA_GPU_3IM, h5filename, "DATA_GPU_3IM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_3LM, DATA_GPU_3LM, h5filename, "DATA_GPU_3LM", LSYNC=.TRUE.)

        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4RB, DATA_GPU_4RB, h5filename, "DATA_GPU_4RB", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4RM, DATA_GPU_4RM, h5filename, "DATA_GPU_4RM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4RD, DATA_GPU_4RD, h5filename, "DATA_GPU_4RD", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4IM, DATA_GPU_4IM, h5filename, "DATA_GPU_4IM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_4LM, DATA_GPU_4LM, h5filename, "DATA_GPU_4LM", LSYNC=.TRUE.)

        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5RB, DATA_GPU_5RB, h5filename, "DATA_GPU_5RB", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5RM, DATA_GPU_5RM, h5filename, "DATA_GPU_5RM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5RD, DATA_GPU_5RD, h5filename, "DATA_GPU_5RD", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5IM, DATA_GPU_5IM, h5filename, "DATA_GPU_5IM", LSYNC=.TRUE.)
        CALL WRITE_HDF5_PERRANK_DATA(FIELD_DATA_5LM, DATA_GPU_5LM, h5filename, "DATA_GPU_5LM", LSYNC=.TRUE.)


        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_1RB, DATA_CPU_1RB, h5filename, "DATA_CPU_1RB")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_1RM, DATA_CPU_1RM, h5filename, "DATA_CPU_1RM")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_1RD, DATA_CPU_1RD, h5filename, "DATA_CPU_1RD")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_1IM, DATA_CPU_1IM, h5filename, "DATA_CPU_1IM")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_1LM, DATA_CPU_1LM, h5filename, "DATA_CPU_1LM")

        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_2RB, DATA_CPU_2RB, h5filename, "DATA_CPU_2RB")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_2RM, DATA_CPU_2RM, h5filename, "DATA_CPU_2RM")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_2RD, DATA_CPU_2RD, h5filename, "DATA_CPU_2RD")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_2IM, DATA_CPU_2IM, h5filename, "DATA_CPU_2IM")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_2LM, DATA_CPU_2LM, h5filename, "DATA_CPU_2LM")

        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_3RB, DATA_CPU_3RB, h5filename, "DATA_CPU_3RB")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_3RM, DATA_CPU_3RM, h5filename, "DATA_CPU_3RM")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_3RD, DATA_CPU_3RD, h5filename, "DATA_CPU_3RD")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_3IM, DATA_CPU_3IM, h5filename, "DATA_CPU_3IM")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_3LM, DATA_CPU_3LM, h5filename, "DATA_CPU_3LM")

        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_4RB, DATA_CPU_4RB, h5filename, "DATA_CPU_4RB")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_4RM, DATA_CPU_4RM, h5filename, "DATA_CPU_4RM")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_4RD, DATA_CPU_4RD, h5filename, "DATA_CPU_4RD")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_4IM, DATA_CPU_4IM, h5filename, "DATA_CPU_4IM")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_4LM, DATA_CPU_4LM, h5filename, "DATA_CPU_4LM")

        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_5RB, DATA_CPU_5RB, h5filename, "DATA_CPU_5RB")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_5RM, DATA_CPU_5RM, h5filename, "DATA_CPU_5RM")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_5RD, DATA_CPU_5RD, h5filename, "DATA_CPU_5RD")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_5IM, DATA_CPU_5IM, h5filename, "DATA_CPU_5IM")
        CALL READ_HDF5_PERRANK_DATA(FIELD_DATA_5LM, DATA_CPU_5LM, h5filename, "DATA_CPU_5LM")
