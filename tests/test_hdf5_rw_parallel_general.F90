...
!        ENDDO
        ...
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_1RB, DATA_GPU_1RB, filenames,"DATA_GPU_1RB")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_1RM, DATA_GPU_1RM, filenames,"DATA_GPU_1RM")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_1RD, DATA_GPU_1RD, filenames,"DATA_GPU_1RD")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_1IM, DATA_GPU_1IM, filenames,"DATA_GPU_1IM")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_1LM, DATA_GPU_1LM, filenames,"DATA_GPU_1LM")

        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_2RB, DATA_GPU_2RB, filenames,"DATA_GPU_2RB")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_2RM, DATA_GPU_2RM, filenames,"DATA_GPU_2RM")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_2RD, DATA_GPU_2RD, filenames,"DATA_GPU_2RD")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_2IM, DATA_GPU_2IM, filenames,"DATA_GPU_2IM")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_2LM, DATA_GPU_2LM, filenames,"DATA_GPU_2LM")

        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_3RB, DATA_GPU_3RB, filenames,"DATA_GPU_3RB")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_3RM, DATA_GPU_3RM, filenames,"DATA_GPU_3RM")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_3RD, DATA_GPU_3RD, filenames,"DATA_GPU_3RD")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_3IM, DATA_GPU_3IM, filenames,"DATA_GPU_3IM")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_3LM, DATA_GPU_3LM, filenames,"DATA_GPU_3LM")

        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_4RB, DATA_GPU_4RB, filenames,"DATA_GPU_4RB")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_4RM, DATA_GPU_4RM, filenames,"DATA_GPU_4RM")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_4RD, DATA_GPU_4RD, filenames,"DATA_GPU_4RD")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_4IM, DATA_GPU_4IM, filenames,"DATA_GPU_4IM")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_4LM, DATA_GPU_4LM, filenames,"DATA_GPU_4LM")

        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_5RB, DATA_GPU_5RB, filenames,"DATA_GPU_5RB")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_5RM, DATA_GPU_5RM, filenames,"DATA_GPU_5RM")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_5RD, DATA_GPU_5RD, filenames,"DATA_GPU_5RD")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_5IM, DATA_GPU_5IM, filenames,"DATA_GPU_5IM")
        CALL GET_HDF5_PERRANK_DATA(FIELD_DATA_5LM, DATA_GPU_5LM, filenames,"DATA_GPU_5LM")
