!CHECK THAT WE CAN CREATE A POINTER OF TYPE FIELD2RB THAN CAN POINT
!TO A FIELD2RB_OWNER OR A FIELD2RB_WRAPPER BUT STILL CALL THE
...
CONTAINS
        SUBROUTINE POINT_TO_WRAPPER(PTR)
                USE FIELD_MODULE
                IMPLICIT NONE
                CLASS(FIELD2RB), POINTER, INTENT(INOUT) :: PTR
                TYPE(FIELD2RB_WRAPPER), POINTER :: W
