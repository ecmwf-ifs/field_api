...
PROGRAM GATHER_SCATTER_COLLAPSE1_LASTDIM
!TEST THAT FIELD_GATHSCAT_COLLAPSE1 ONLY MODIFY VALUES THAT HAVE BEEN FILTERED
USE FIELD_MODULE
...
TYPE (FIELD_GATHSCAT_COLLAPSE1):: FGS
