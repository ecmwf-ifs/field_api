...
!It is necessary the specialize the code, HDF5 constants must be passed directly
        ...
        ENDDO
        ENDDO
        CALL GET_HDF5_PERRANK_DATA(W,D_CPU,filenames,"W")
        CALL GET_HDF5_PERRANK_DATA(WM,DM_CPU,filenames,"WM")
        CALL GET_HDF5_PERRANK_DATA(WD,DD_CPU,filenames,"WD")
        CALL GET_HDF5_PERRANK_DATA(WI,DI_CPU,filenames,"WI")
        CALL GET_HDF5_PERRANK_DATA(WL,DL_CPU,filenames,"WL")
