...
SUBROUTINE NAME_HDF5_STORAGE(FILENAME,FNAME_WITH_RANK)
  ...
  #ifdef FIELD_API_IO_MPL
  USE MPL_MODULE, ONLY: MPL_NUMPROC, MPL_RANK
  #elif FIELD_API_IO_MPI
  ...
  #elif FIELD_API_IO_SERIAL
  NUMB_RANKS=1
  MY_RANK=0
  #else
  #error "Name of HDF5 file cannot be specified without specifying FIELD_API_IO mode: _SERIAL, _MPI or _MPL"
  #endif
!  RANK_LEN = CEILING(LOG10(REAL(ABS(MY_RANK)+1)))  
!  PRINT *,'RANK_LEN',RANK_LEN
