...
CONTAINS
  ...
  PROCEDURE :: SET_DEVICE_FRESH => FIELD_BASIC_SET_DEVICE_FRESH
  PROCEDURE :: SET_HOST_FRESH => FIELD_BASIC_SET_HOST_FRESH
  PROCEDURE :: SET_STATUS => FIELD_BASIC_SET_STATUS
  PROCEDURE :: GET_STATUS => FIELD_BASIC_GET_STATUS
  PROCEDURE :: IS_STATUS => FIELD_BASIC_IS_STATUS
  PROCEDURE :: ADD_STATUS => FIELD_BASIC_ADD_STATUS
  PROCEDURE :: REMOVE_STATUS => FIELD_BASIC_REMOVE_STATUS
...
ABSTRACT INTERFACE
  ...
  END SUBROUTINE
  SUBROUTINE FIELD_BASIC_SYNC_FORCE (SELF, QUEUE)
    IMPORT FIELD_BASIC, JPIM
    CLASS(FIELD_BASIC) :: SELF
...
CALL SELF%SET_STATUS( IOR( IAND(SELF%GET_STATUS(), NOT(UNDEFINED)) , NDEVFRESH))
...
CALL SELF%SET_STATUS( IOR( IAND(SELF%GET_STATUS(), NOT(UNDEFINED)) , NHSTFRESH))

END SUBROUTINE FIELD_BASIC_SET_HOST_FRESH
...
SUBROUTINE FIELD_BASIC_ADD_STATUS(SELF, KSTATUS)

CLASS (FIELD_BASIC) :: SELF
INTEGER, INTENT(IN) :: KSTATUS
CALL SELF%SET_STATUS(IOR(SELF%ISTATUS, KSTATUS))

END SUBROUTINE FIELD_BASIC_ADD_STATUS

SUBROUTINE FIELD_BASIC_REMOVE_STATUS(SELF, KSTATUS)

CLASS (FIELD_BASIC) :: SELF
INTEGER, INTENT(IN) :: KSTATUS
CALL SELF%SET_STATUS(IAND(SELF%ISTATUS, NOT(KSTATUS)))

END SUBROUTINE FIELD_BASIC_REMOVE_STATUS

LOGICAL FUNCTION FIELD_BASIC_IS_STATUS (SELF, KSTATUS)

CLASS (FIELD_BASIC) :: SELF
INTEGER, INTENT(IN) :: KSTATUS

FIELD_BASIC_IS_STATUS = (IAND(SELF%GET_STATUS(), KSTATUS) == KSTATUS)
