...
MODULE MEM_POOL_MODULE
   ...
   ABSTRACT INTERFACE
      SUBROUTINE MEM_BLK_INIT_METHOD(SIZE, DATA, LPINNED)
         IMPORT C_SIZE_T, C_PTR
         INTEGER(C_SIZE_T), INTENT(IN) :: SIZE
         TYPE(C_PTR), INTENT(OUT) :: DATA
         LOGICAL, INTENT(OUT) :: LPINNED
      END SUBROUTINE MEM_BLK_INIT_METHOD
      SUBROUTINE MEM_BLK_FINAL_METHOD(DATA, LPINNED)
         IMPORT C_PTR
   ...
   CONTAINS
      ...
      SUBROUTINE MEM_BLOCK_INIT( SELF )
         ...
         CALL MEM_BLK_INIT(SELF%SIZE, SELF%DATA, SELF%LPINNED)
      ...
      SUBROUTINE MEM_BLOCK_FINAL( SELF )
         ...
         CALL FINAL_METHOD(SELF%DATA, SELF%LPINNED)
