...
PUBLIC :: FIELD_STATISTICS_TYPE
PUBLIC :: FIELD_STATISTICS_ENABLE, FIELD_STATISTICS
PUBLIC :: FIELD_STATISTICS_NEW, FIELD_STATISTICS_DELETE
PUBLIC :: FIELD_STATISTICS_HOST_ALLOCATE, FIELD_STATISTICS_HOST_DEALLOCATE
PUBLIC :: FIELD_STATISTICS_DEVICE_ALLOCATE, FIELD_STATISTICS_DEVICE_DEALLOCATE
